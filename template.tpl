...
const action = () => {
  if(data){
    ...
    } else if (data.actionsMenu === 'language' && data.survey_language) {
      callInWindow('_blitzQueue.push', ['setSurveyLanguage', data.survey_language]);
    } 
    data.gtmOnSuccess();
  }
};
...
Created on 04/05/2023, 1:00:00 PM